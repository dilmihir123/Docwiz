...
export class MapContainer10 extends Component {
  state = {
          ...
          {props => (
            <div style={props}>
              ...
              >
                <Container>
                  <h4>
                    We have detected the presence of Pneumonia post examining
                    the image and you may be prone to this disease
                  </h4>
                  <h6>Chennai's best Pneumonia Treatment Hospitals</h6>
                  <p>
                    Kindly direct to your nearest Pneumonia Treatment Hospital
                    and specialised doctors from list below!{" "}
                  </p>
                </Container>
              </Jumbotron>
            </div>
                ...
                <Container>
                  <ul style={{ listStyle: "none" }}>
                    <li data-val="Audi">
                      ...
                      />
                      <h1>Dr.X</h1>
                      <h3>Cardiologist at Kauvery Hospital</h3>
                    ...
                    <li data-val="BMW">
                      ...
                      />
                      <h1>Dr.Y</h1>
                      <h3>Cardiologist at Apollo Hospital</h3>
