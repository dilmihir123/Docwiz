...
export class MapContainer9 extends Component {
  state = {
          ...
          {props => (
            <div style={props}>
              ...
              >
                <Container>
                  <h4>
                    We have detected the presence of a heart ailment and you may
                    be prone to this disease
                  </h4>
                  <h6>Chennai's best Heartcare Hospitals</h6>
                  <p>
