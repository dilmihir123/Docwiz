...
export class MapContainer11 extends Component {
  state = {
          ...
          {props => (
            <div style={props}>
              ...
              >
                <Container>
                  <h4>
                    We have detected the presence of a Liver disease and you may
                    be prone to this disease
                  </h4>
                  <h6>Chennai's best Liver Speciality Hospitals</h6>
                  <p>
