...
class BrainTA extends Component {
  home() {
    let path = "./UserDash";
          ...
          <Jumbotron fluid>
            <Container>
              <h1>Brain Tumor</h1>
                ...
                brain, is very rigid. Any growth inside such a restricted 
                space can cause problems. Brain tumors can be cancerous (malignant) 
                or noncancerous (benign). When benign or malignant tumors grow, they 
                an cause the pressure inside your skull to increase. This can cause 
                ...
                Many primary brain tumors are benign. A secondary 
                brain tumor, also known as a metastatic brain tumor, 
                occurs when cancer cells spread to your brain from 
