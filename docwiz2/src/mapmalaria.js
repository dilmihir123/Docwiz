...
export class MapContainer3 extends Component {
  state = {
          ...
          {props => (
            <div style={props}>
              ...
              >
                <Container>
                  <h4>
                    We have detected the presence of Malaria in your blood cell
                    image and you may be prone to this disease
                  </h4>
                  <h6>Chennai's best Malaria Hospitals</h6>
                  <p>
                    Kindly direct to your nearest Heartcare Hospital and
                    specialised doctors from list below!{" "}
                  </p>
                </Container>
              </Jumbotron>
            </div>
                ...
                <Container>
                  <ul style={{ listStyle: "none" }}>
                    <li data-val="Audi">
                      ...
                      />
                      <h1>Dr.X</h1>
                      <h3>Doctor at Kauvery Hospital</h3>
                    ...
                    <li data-val="BMW">
                      ...
                      />
                      <h1>Dr.Y</h1>
                      <h3>Doctor at Apollo Hospital</h3>
